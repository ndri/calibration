...
<div class={['relative', className]} bind:this={dropdownRef} onfocusout={handleCloseOnFocusOut}>
	...
	{#if isOpen}
		...
		>
			<div
				class="absolute top-full right-0 z-10 mt-1 flex min-w-40 origin-top-right flex-col rounded-md bg-white ring-1 ring-main-300 dark:bg-main-950 dark:ring-main-800"
				role="menu"
